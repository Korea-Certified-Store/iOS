...
extension MockURLProtocol {
    ...
    enum MockJSONFile {
        ...
        case fetchAutoCompletionSuccess
        case fetchAutoCompletionSuccessWithZeroAutoCompletion
        ...
        var fileName: String {
            ...
            case .fetchAutoCompletionSuccess:
                return "FetchAutoCompletionSuccess"
            case .fetchAutoCompletionSuccessWithZeroAutoCompletion:
                return "FetchAutoCompletionSuccessWithZeroAutoCompletion"
            }
        }
